...
const SERVICES_DATA = [
  ...
  },
  {
    ...
    content: 'Nếu tổ chức của bạn muốn nhanh chóng phát triển hoặc nâng cao kỹ năng trong thời gian ngắn, Học viện AI cho Việt Nam được ủy quyền chính thức của NVIDIA đang phối hợp tổ chức các khóa đào tạo trực tuyến và hội thảo trực tiếp để bồi dưỡng nhân tài AI.'
  },
  {
    title: 'Tài liệu miễn phí dành cho giáo viên',
    content: 'Với nhu cầu ngày càng cao đối với các chuyên gia có kiến thức về AI, Học viện AI cho Việt Nam (DLI) cung cấp nhiều nguồn tài nguyên đa dạng. Bạn có thể sử dụng nền tảng phòng thí nghiệm hoặc tài liệu dạy về nhiều chủ đề để giảng dạy của mình.'
  }
] as const
